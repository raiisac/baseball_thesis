...
The main contribution of this report is the analysis of the translations in Dutch and French of three scales. To our knowledge, these are the first translations from English to Dutch and French. Our analysis may aid researchers in the future when investigating similar topics that involve outdoor play or nature connectedness in children or risk engagement and protection in parents. 
...
While the original scale showed a negative correlation between ATOP_fears and ATOP_benefits [@beyer2015development], out CFA model showed a positive, non-significant correlation for but the Dutch and French translation.
...
As the current Dutch and French version of the REPS scale was deemed too unreliable and the CFA fit was not acceptable, we excluded the REPS scale from the SEM. This unfortunately also means that research question 4 can currently not be investigated further with model.
...
Boys are expected to have a lower ATOP_benefits score and a higher ATOP_fears score.


For Research question 6, we conclude that the direct school surroundings (the naturalness of the landscape outside the school) play an important role in ATOP_benefits and NC, but the greenness of the playground does not.
A more natural environment around the school is expected to lead to higher ATOP_benefits and NC.
Many of the B@seball project research questions focus on the the link between the playground's greenness and the children's mental and physical health. While we did not include any health variables in the SEM for now, it does suggest that the greenness of the playground has a very minimal or no impact on ATOP_benefits, ATOP_fears and NC.
The SEM shows that green playground may even lead to lower ATOP_benefits.
...
The composite reliability of ATOP_fears was disappointing and a validity analysis revealed that the current version may not be measure what it should be measuring.
...
In the B@seball project, around 60 school guardians also filled in a brief survey on how they mind the children while playing outside.
This survey also included the REPS scale.
Analyzing this data may improve the SEM as this may provide information on the type of playground (grey or green) but also how much freedom children are allowed while playing outside in school.
However, seeing that the quality of the REPS scale was not good in parents, the same problems will likely surface in the school guardians' data, especially since this data set is even smaller.
...
*school guardians
*linking them to health variables
