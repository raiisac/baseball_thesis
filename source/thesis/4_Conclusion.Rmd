...
A model with metric measurement invariance was chosen which showed good fit.
...
While the original scale showed a negative correlation between ATOP_fears and ATOP_benefits [@beyer2015development], the CFA model showed a positive, non-significant correlation for both the Dutch and French translation.
...
The SEM shows that a green playground may even lead to slightly lower ATOP_benefits.
...
Analyzing this data may improve the SEM as this may provide information how much freedom children are allowed while playing outside in school, in addition to the type of playground (grey or green).
