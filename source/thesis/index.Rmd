...
My family and friends for endless trust, support, and the necessary break with entertainment.
...
Among many other health and mental development parameters, several standardized scale questions were introduced in surveys. These standardised scales are the main focus of this work.

Children were first asked about their Attitude Towards Outdoor Play (ATOP) [@beyer2015development]. ATOP has two subscales, *ATOP_benefits* and *ATOP_fears*, that are measured on a likert scale by seven and four statements respectively. *ATOP_benefits* is high if the child values the benefits that outdoor play may have and *ATOP_fears* is high if the child is fearful of some elements of outdoor play. Second, the children's *Nature connectedness* (NC) is measured with six affective statements, based on @hunt2017monitor.

Parents' tendency to (1) let children engage with risk and (2) prevent injuries is measures with two latent factors, *REPS_risk_engagement* and *REPS_injury_prevention*, based on six and eight statements respectively from the Risk Engagement and Protection Survey (REPS) [@olsen2018risk].

The first contribution of this report is analyzing these three scales (ATOP, REPS, and NC), which were translated from English to Dutch and French, and checking whether they reliably measure the underlying constructs. 
Using multi-group confirmatory factor analyses, we concluded that (1) NC can reliably measure a child's connection to nature, (2) ATOP can measure ATOP_benefits quite well but the ATOP_fears subscale still needs some improvement, (3) the two subscales in the translated REPS can currently not reliably measure the REPS_risk_engagement and REPS_injury_prevention concepts.

A second important contribution of this report is 
