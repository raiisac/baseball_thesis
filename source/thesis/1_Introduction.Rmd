...
A second set of scale questions was based on Nature England's monitor of engagement with the natural environment or *nature connectedness* (NC) survey [@hunt2017monitor]. Six affective statements on nature connectedness were translated in Dutch and French. The original statements had a Cronback Alpha of 0.918 and 0.899 in adults and children respectively.  This leads us to our second research question.

:::: {.center data-latex=""}

::: {.minipage data-latex="{.5\linewidth}"}
RQ2: Is the translated nature connectedness scale still a reliable measure of the corresponding concept?
:::
