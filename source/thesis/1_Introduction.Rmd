...
Project partners are the University of Antwerp,  Sciensano, Goodplanet, UC Louvain, [\text{\underline{MOS}}](https://www.mosvlaanderen.be/), and INBO (the project website can be found [\text{\underline{here}}](https://www.uantwerpen.be/nl/projecten/baseball/)). The main aim of the B@seball project is to investigate whether and how biodiversity at the school environment can influence the students' physical and mental health. 
...
In the thesis, we will refer to green playground as playgrounds that have many trees, many shrubs, flowers, sand, dirt, maybe even a water feature or a vegetable patch.
...
::: {.minipage data-latex="{.5\linewidth}"}
RQ3: Is the translated REPS questionnaire still reliable and valid?
:::
...
::: {.minipage data-latex="{.5\linewidth}"}
RQ4: Is ATOP in children related to their parents' REPS?

RQ5: Is the child's socio-economic status related to their NC, ATOP, or their parent's REPS score?
