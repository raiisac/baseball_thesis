...
# Detailed graphical representation of the answers for Dutch and French speaking children and parents seperately
...
In this section, we also show the coefficient estimates and standard errors for each of the final cfa models.
...
t[, -1] %>%
  kable(booktabs = TRUE,
        caption = "Unstandardized coefficient estimates and standard errors for the metric measurement invariance model for ATOP to compare Dutch versus French-speaking respondents",
...
```{r nc-descriptives2, message=FALSE, warning=FALSE, include=TRUE, echo = FALSE, fig.cap = "Descriptive statistics for Dutch-speaking (left) and French-speaking (right) children for the Nature connectedness scale items. Non-responses are not shown but taken into account when calculating the percentages.", fig.width = 6.5, fig.height = 5}
...
t[, -1] %>%
  kable(booktabs = TRUE,
        caption = "Unstandardized coefficient estimates and standard errors for the metric measurement invariance model for NC to compare Dutch versus French-speaking respondents",
        col.names = c("", "Estimate", "SE", "Estimate", "SE"),
        digits = 3) %>%
  kableExtra::kable_styling(font_size = 9) %>%
  kableExtra::add_header_above(c("", "Dutch speaking" = 2,
...
t[1:34, -1] %>%
  kable(booktabs = TRUE,
        caption = "Unstandardized coefficient estimates and standard errors for the metric measurement invariance model for REPS to compare Dutch versus French-speaking respondents",
        col.names = c("", "Estimate", "SE", "Estimate", "SE"),
        digits = 3) %>%
  kableExtra::kable_styling(font_size = 9) %>%
  kableExtra::add_header_above(c("", "Dutch speaking" = 2,
...
t[35:51, -1] %>%
  kable(booktabs = TRUE,
        caption = "Unstandardized coefficient estimates and standard errors for the metric measurement invariance model for REPS to compare Dutch versus French-speaking respondents (continued)",
        col.names = c("", "Estimate", "SE", "Estimate", "SE"),
        digits = 3,
        row.names = FALSE) %>%
  kableExtra::kable_styling(font_size = 9) %>%
...
# Additional factor analysis information

## Risk engagement and protection survey: exploratory factor analysis {#repsefa}
...
We use exploratory factor analysis (EFA) to check whether these might fit any of the original REPS factors. EFA based on only the complete observations (Table \@ref(tab:reps-efa1)) or on the whole dataset, using multiple imputation (Table \@ref(tab:reps-efa2)) both show that the two additional statements do not fit well with the original REPS scales.
