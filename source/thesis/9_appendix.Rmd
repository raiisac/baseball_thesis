...
We use exploratory factor analysis (EFA) to check whether these might fit any of the original REPS factors. The following two tables show that the two additional statements do not fit well with the original REPS scales, based on EFA with only the complete observations or on the whole dataset, using multiple imputation.
