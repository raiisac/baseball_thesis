...
Table \@ref(tab:atop-translation-kids), \@ref(tab:atop-translation),  \@ref(tab:reps-translation), and \@ref(tab:im-translation) in chapter \@ref(translate) in the appendix show the original English question and the translation in both Dutch and French. 
...
The surveys were distributed in ???WHEN??? and filled in over several months time.
...
All data cleaning was performed in R. 

The B@seball researchers published cleaned data packages that can be easily read by researchers, including the meta-data, using R's [**frictionless** package](https://cran.r-project.org/web/packages/frictionless/vignettes/frictionless.html).
