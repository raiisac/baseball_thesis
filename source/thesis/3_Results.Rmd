...
- Education level parents score:
  ...
  - University: 1
- Employment score (for respondent + partner)
  - unemployed: 0
  - labourer: 1/3
...
These three scores (all with values between 0 and 1) were first averaged per child to get the child-level SES. Then, it is averaged over children per school to arrive at a school-level SES.
...
Correlations between the statements *calm_down* and *learn_new_things* and between *calm_down* and *feeling_free* were added to the model of @beyer2015development to improve the fit. Table \@ref(tab:atop-loadings) and \@ref(tab:atop-loadings2)  in the appendix show the raw and standardized model estimates.
